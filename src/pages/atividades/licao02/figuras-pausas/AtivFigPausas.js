...
import * as activityStyles from './AtivFigPausasStyles';
...
function AtivFigPausas() {
  ...
  const session = useActivitySession('ativ-fig-pausas');
  ...
  const flow = useActivityFlow({
    activityName: 'Figuras de Pausas',
    session,
    user,
    headerRef,
    navigation,
